...
test("portable update url reads windows installer url from updater raw json", () => {
	assert.equal(
		getPortableUpdateUrl({
			platforms: {
				"windows-x86_64": {
					url: "https://github.com/jpbhatt21/integrated-mod-manager/releases/download/v3.2.17/Integrated.Mod.Manager.IMM._3.2.17_x64-setup.exe",
				},
			},
		}),
		"https://github.com/jpbhatt21/integrated-mod-manager/releases/download/v3.2.17/Integrated.Mod.Manager.IMM._3.2.17_x64-setup.exe"
	);
});
